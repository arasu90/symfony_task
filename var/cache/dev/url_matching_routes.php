...
return [
    ...
    [ // $staticRoutes
        ...
        '/view_cart' => [[['_route' => 'viewCart', '_controller' => 'App\\Controller\\CartController::viewCart'], null, ['GET' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        65 => [[['_route' => 'viewMyOrderList', '_controller' => 'App\\Controller\\CartController::viewMyOrderList'], ['customer_id'], null, null, false, true, null]],
        96 => [
